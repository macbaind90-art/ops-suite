...
if(JSON.stringify(scriptRefs)!==JSON.stringify(expectedRefs)) throw new Error('Front-end script load order does not match the v4.4.0 architecture contract.');
...
// v4.4.0: render a real linked Employee Profile, not just the empty profile shell.
