PWADC SECURITY OPERATIONS SUITE v2.2.3.0 BUILD KIT
...
- Attendance v2.2.3.0 live module using the provided 2026-06-01 attendance JSON as the seed data
...
Run the Actions workflow named: Build PWADC Security Operations Suite v2.2.3.0
...
v2.2.3.0 patch: Daily Entry now groups employees by shift and the desktop bridge replaces an empty/stub attendance-data.json with the seeded live attendance backup.
