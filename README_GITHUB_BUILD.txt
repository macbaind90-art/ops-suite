PWADC SECURITY OPERATIONS SUITE v2.1.2 BUILD KIT
...
- Attendance v2.1.2 live module using the provided 2026-06-01 attendance JSON as the seed data
...
Run the Actions workflow named: Build PWADC Security Operations Suite v2.1.2
Download artifact: PWADC-Security-Operations-Suite-v2-1-2-Windows
...
v2.1.2 patch: Daily Entry now groups employees by shift and the desktop bridge replaces an empty/stub attendance-data.json with the seeded live attendance backup.
