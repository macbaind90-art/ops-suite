/* PWADC Security Operations Suite v4.0.0 | module: workflows-home */
...
function printStartHere(){openReportWindow(reportDoc('Start Here','v4.0.0 Attendance Point System',document.querySelector('#page-start-here')?.innerHTML||renderStartHere(),'portrait'),false)}
...
function renderHome(){
 ...
 return `<div class="page-head"><div><div class="page-title">Security Operations Command Center</div><div class="page-sub">${env.user||'User'} @ ${env.machine||'Machine'} · v4.0.0</div></div><div class="btn-group"><button onclick="navigate('start-here')">Start Here</button><button onclick="activeAttView='daily';navigate('attendance')">Daily Attendance</button><button class="gold" onclick="activeAttView='review';navigate('attendance')">Point Review</button><button class="admin-only" onclick="backupEverything()">Backup</button></div></div>
