/* PWADC Security Operations Suite v3.3.0.7 | module: workflows-home */
...
function renderHome(){
 ...
 return `<div class="page-head"><div><div class="page-title">Security Operations Command Center</div><div class="page-sub">${env.user||'User'} @ ${env.machine||'Machine'} · v3.3.0.7</div></div><div class="btn-group"><button onclick="navigate('start-here')">Start Here</button><button onclick="navigate('shift-reports')">Import Reports</button><button class="gold" onclick="navigate('shift-intelligence')">Review Intelligence</button><button class="admin-only" onclick="backupEverything()">Backup</button></div></div>
