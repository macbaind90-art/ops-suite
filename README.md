# PWADC Security Operations Suite v3.1.8

Stable Operations Management release.

Expected artifact: `PWADC-Security-Operations-Suite-v3-1-8-Windows`
...
## v3.1.8 Training / Readiness polish release notes
