# PWADC Security Operations Suite v3.1.9

Stable Operations Management release.

Expected artifact: `PWADC-Security-Operations-Suite-v3-1-9-Windows`
...
## v3.1.9 Training / Readiness polish release notes
...
## v3.1.9 Training Page Separation
