...
namespace PWADC.SecurityOperationsSuite
{
    public partial class MainForm : Form
    {
        ...
        private void CreateSuiteLockFile()
        {
            ...
            {
                EnsureFolders();
                var lockInfo = new { user = Environment.UserName, machine = Environment.MachineName, openedAt = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"), version = "3.5.0.4" };
        ...
        private object GetEnvironmentInfo() => new { user = Environment.UserName, machine = Environment.MachineName, version = "3.5.0.4", baseDirectory = AppContext.BaseDirectory };
